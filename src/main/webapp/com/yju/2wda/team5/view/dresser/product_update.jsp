...
<main>
	...
	<section>
		...
		<form method="post" action="./productUpdate.be" enctype="multipart/form-data">
			...
			<input type="text" id="product_name" name="product_name" value="<%=item.getProduct_name()%>"><br>
			...
			<input type="text" id="product_price" name="product_price" value="<%=item.getProduct_price() %>"><br>
			
			<label for="product_stock">재고량:</label>
			<input type="text" id="product_stock" name="product_stock" value="<%=item.getProduct_stock() %>"><br>
			...
			상품 설명:
			<textarea name="product_desc"><%=item.getProduct_desc() %></textarea><br>
