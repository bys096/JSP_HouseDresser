...
public class GetOrderHistoryActionByAdmin implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ArrayList<OrderDTO> adminOrderList = dao.getOrderHistoryByAdmin();
		session.setAttribute("adminOrderList", adminOrderList);
		...
		if(result == true) {
			forward.setPath("/com/yju/2wda/team5/view/dresser/admin_order_history.jsp");
		} else {
